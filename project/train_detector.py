...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--loss_pos_weight", type=float, default=30.0)
    ...
    p.add_argument("--model_type", type=str, default="unet", choices=["unet", "unet_deep"])
    p.add_argument("--use_clahe", action="store_true", help="Enable CLAHE preprocessing")
    ...
    p.add_argument("--early_stop_patience", type=int, default=0, help="Early stopping patience (0 to disable)")
